...
compare it with the state expected after the already accepted plan prefix. A
mismatch aborts the remaining suffix without submitting the binding command.
